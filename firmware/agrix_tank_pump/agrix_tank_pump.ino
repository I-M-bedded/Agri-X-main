...
//
//  확정 핀맵 (Mega 보드의 D핀 번호):
//    HC-SR04  VCC  -> Mega 5V
//             GND  -> Mega GND
//             TRIG -> Mega D30
//             ECHO -> Mega D31  (Mega는 5V 로직 입력 가능)
//    LR7843   PWM  -> Mega D9
//             GND  -> Mega GND
//
//  펌프 전력은 Mega 5V 핀에서 끌어 쓰지 말고 별도 전원을 사용합니다.
//  Mega GND, LR7843 전력 GND, 펌프 전원 GND는 반드시 공통으로 묶습니다.
//  ToF 2개는 Mega가 아니라 Pi에 연결합니다
//  (Pi 물리핀: SDA=3, SCL=5, XSHUT1=29, XSHUT2=31).
// ---------------------------------------------------------------------
//  프로토콜 (줄 단위 ASCII)
//    Pi -> Mega
...
constexpr uint8_t PUMP_PWM_PIN = 9;   // LR7843 PWM/SIG (Timer2 OC2B)
